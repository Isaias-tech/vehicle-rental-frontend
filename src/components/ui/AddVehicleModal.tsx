...
export const AddVehicle: React.FC<AddVehicleProps> = ({ onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Append required picture1 and optional pictures
    if (picture1) {
      formData.append('picture1', picture1);
    } else {
      setError('Picture 1 is required.');
      setLoading(false);
      return;
    }
    ...
    <div className="modal modal-open">
      <div className="modal-box">
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          ...
          {/* File input for required picture1 */}
          <div className="form-control">
            <label className="label">Picture 1 (Required)</label>
            <input
              type="file"
          ...
          {/* File inputs for optional pictures */}
          <div className="form-control">
